...
During my degree studies, I undertook a project for my Final Year Project (FYP) subject. This project focused on predicting mental health conditions using machine learning algorithms, specifically K-Nearest Neighbors (KNN) and XGBoost. The project aimed to leverage data-driven insights to identify potential mental health issues based on input features of behavioral data.
...
To further develop my project, I deployed it on Render to make it accessible to the public and can be access through this link
https://mental-health-detector-o7pb.onrender.com

This experience enhanced my skills in data analysis, algorithm implementation, and machine learning, while also fostering a deeper understanding of the intersection between technology and mental health. Thank you
